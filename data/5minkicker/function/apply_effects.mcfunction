...
execute if data storage game:playerdata data.active_effects[0] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[0] store result storage game:playerdata data.active_effects[0].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[1] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[1] store result storage game:playerdata data.active_effects[1].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[2] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[2] store result storage game:playerdata data.active_effects[2].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[3] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[3] store result storage game:playerdata data.active_effects[3].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[4] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[4] store result storage game:playerdata data.active_effects[4].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[5] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[5] store result storage game:playerdata data.active_effects[5].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[6] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[6] store result storage game:playerdata data.active_effects[6].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[7] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[7] store result storage game:playerdata data.active_effects[7].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[8] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[8] store result storage game:playerdata data.active_effects[8].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[9] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[9] store result storage game:playerdata data.active_effects[9].duration int 1 run scoreboard players get #game edt
...
execute if data storage game:playerdata data.active_effects[10] run scoreboard players operation #game edt /= #game twenty
execute if data storage game:playerdata data.active_effects[10] store result storage game:playerdata data.active_effects[10].duration int 1 run scoreboard players get #game edt
execute if data storage game:playerdata data.active_effects[10] run function 5minkicker:apply_effect with storage game:playerdata data.active_effects[10]